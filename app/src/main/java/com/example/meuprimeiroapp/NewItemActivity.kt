...
class NewItemActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private var imageFile: File? = null // Variável para armazenar o arquivo da imagem temporária File
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        binding.mapContent.visibility = android.view.View.VISIBLE
        getDeviceLocation()
    ...
    private fun requestLocationPermission() {
        // Implementar lógica para solicitar permissão de localização
        fusedLocationClient = LocationServices.getFusedLocationProviderClient(this)
        // Se o usuário permitiu a localização, obtenha a última localização do dispositivo
    ...
    private fun uploadImageToFirebase() {
        imageFile?.let {
        // Lógica para fazer upload da imagem para o Firebase Storage
        ...
        // Fazer upload da imagem para o Firebase Storage
            ...
            imageRef.putBytes(data)
                .addOnFailureListener {
                    ...
                    Toast.makeText(
                        this,
                        "Falha ao fazer o Upload para o Firebase",
                        Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    private fun validateForm(): Boolean {
        ...
        return !hasError //se tem erro retorna false, se não retorna true
    }
